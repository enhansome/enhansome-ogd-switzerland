...
[<img alt="linting - Ruff" class="off-glb" loading="lazy" src="https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json">](https://github.com/astral-sh/ruff) ⭐ 49,390 | 🐛 2,157 | 🌐 Rust | 📅 2026-08-30
...
* [geospatial-data-catalogs](https://github.com/giswqs/geospatial-data-catalogs) ⭐ 661 | 🐛 0 | 🌐 Python | 📅 2026-08-30 - A list of open geospatial datasets available on AWS, Earth Engine, Planetary Computer, NASA CMR, and STAC Index.
...
* [Neue Zürcher Zeitung Visuals Team](https://github.com/nzzdev/st-methods) ⭐ 57 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-30 - Repository containing methods and code used for stories by [NZZ Visuals](https://twitter.com/nzzvisuals).
...
* [Awesome Public Datasets](https://github.com/awesomedata/awesome-public-datasets#government) ⭐ 78,712 | 🐛 159 | 📅 2026-08-29 - GitHub list with many more links to public government datasets.
