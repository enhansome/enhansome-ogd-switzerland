...
[![GitHub Stars](https://img.shields.io/github/stars/rnckp/awesome-ogd-switzerland.svg)](https://github.com/rnckp/awesome-ogd-switzerland) ⭐ 175 | 🐛 0 | 🌐 Python | 📅 2026-08-14
...
[<img alt="linting - Ruff" class="off-glb" loading="lazy" src="https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json">](https://github.com/astral-sh/ruff) ⭐ 49,458 | 🐛 2,161 | 🌐 Rust | 📅 2026-09-03
...
* [Open Energy Data CH](https://github.com/OpenEnergyData/energy-data-ch) ⭐ 15 | 🐛 7 | 📅 2023-09-14 - List of open datasets related to energy projects in Switzerland. See also this [Open Data CH hackday contribution](https://hack.opendata.ch/project/851) for [Energy Hackday 2020](https://hack.opendata.ch/event/31).
...
* [geospatial-data-catalogs](https://github.com/giswqs/geospatial-data-catalogs) ⭐ 662 | 🐛 0 | 🌐 Python | 📅 2026-09-03 - A list of open geospatial datasets available on AWS, Earth Engine, Planetary Computer, NASA CMR, and STAC Index.
* [GeoHarvester](https://davidoesch.github.io/geoservice_harvester_poc/) - Portal that brings together official geodata from Swiss government entities. \[[GitHub](https://github.com/davidoesch/geoservice_harvester_poc) ⭐ 5 | 🐛 17 | 🌐 Python | 📅 2026-08-30]
...
* [OpenERZ](https://github.com/metaodi/openerz) ⭐ 33 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-02 - OpenERZ is an open API for waste collection data from many different municipalities in Switzerland (e.g., Zurich, Basel, St. Gallen, Uster, Thalwil, Adliswil, and Horgen). API and Python client provided by OGD wizard [metaodi](https://github.com/metaodi), aka Stefan Oderbolz.
...
* [Neue Zürcher Zeitung Visuals Team](https://github.com/nzzdev/st-methods) ⭐ 57 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-09-03 - Repository containing methods and code used for stories by [NZZ Visuals](https://twitter.com/nzzvisuals).
...
* [Awesome Public Datasets](https://github.com/awesomedata/awesome-public-datasets#government) ⭐ 78,779 | 🐛 157 | 📅 2026-09-02 - GitHub list with many more links to public government datasets.
* [Awesome Transit](https://github.com/CUTR-at-USF/awesome-transit) ⭐ 1,827 | 🐛 21 | 📅 2026-07-24 - Community list of transit APIs, apps, datasets, research, and software.
* OKFN Data Portals \[[Website](https://dataportals.org/)] \[[GitHub repo](https://github.com/okfn/dataportals.org) ⭐ 170 | 🐛 84 | 🌐 Nunjucks | 📅 2026-08-18] - Very large, comprehensive list of data sources maintained by the [Open Knowledge Foundation](https://okfn.org/).

### Miscellaneous

* [Awesome Hackathon](https://github.com/dribdat/awesome-hackathon) ⭐ 292 | 🐛 2 | 📅 2026-05-05 - Recommendations for crowdsourcing tools, primarily from the open data community.
