...
[<img alt="linting - Ruff" class="off-glb" loading="lazy" src="https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json">](https://github.com/astral-sh/ruff) ⭐ 49,554 | 🐛 2,179 | 🌐 Rust | 📅 2026-09-09
...
* [geospatial-data-catalogs](https://github.com/giswqs/geospatial-data-catalogs) ⭐ 662 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - A list of open geospatial datasets available on AWS, Earth Engine, Planetary Computer, NASA CMR, and STAC Index.
...
* [Federal Open Source GitHub Index](https://github.com/swiss/index) ⭐ 32 | 🐛 0 | 📅 2026-09-08 - An overview of the current GitHub organisations maintained by the Swiss Confederation.
...
* [Neue Zürcher Zeitung Visuals Team](https://github.com/nzzdev/st-methods) ⭐ 57 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-09-09 - Repository containing methods and code used for stories by [NZZ Visuals](https://twitter.com/nzzvisuals).
...
* [Awesome Public Datasets](https://github.com/awesomedata/awesome-public-datasets#government) ⭐ 78,879 | 🐛 158 | 📅 2026-09-08 - GitHub list with many more links to public government datasets.
...
* [Awesome Hackathon](https://github.com/dribdat/awesome-hackathon) ⭐ 293 | 🐛 2 | 📅 2026-05-05 - Recommendations for crowdsourcing tools, primarily from the open data community.
