...
[<img alt="linting - Ruff" class="off-glb" loading="lazy" src="https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json">](https://github.com/astral-sh/ruff) ⭐ 49,601 | 🐛 2,188 | 🌐 Rust | 📅 2026-09-12
...
* [geospatial-data-catalogs](https://github.com/giswqs/geospatial-data-catalogs) ⭐ 662 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - A list of open geospatial datasets available on AWS, Earth Engine, Planetary Computer, NASA CMR, and STAC Index.
...
* [OpenERZ](https://github.com/metaodi/openerz) ⭐ 33 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-10 - OpenERZ is an open API for waste collection data from many different municipalities in Switzerland (e.g., Zurich, Basel, St. Gallen, Uster, Thalwil, Adliswil, and Horgen). API and Python client provided by OGD wizard [metaodi](https://github.com/metaodi), aka Stefan Oderbolz.
...
* [Neue Zürcher Zeitung Visuals Team](https://github.com/nzzdev/st-methods) ⭐ 57 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-09-12 - Repository containing methods and code used for stories by [NZZ Visuals](https://twitter.com/nzzvisuals).
...
* [Awesome Public Datasets](https://github.com/awesomedata/awesome-public-datasets#government) ⭐ 78,921 | 🐛 159 | 📅 2026-09-11 - GitHub list with many more links to public government datasets.
* [Awesome Transit](https://github.com/CUTR-at-USF/awesome-transit) ⭐ 1,831 | 🐛 21 | 📅 2026-07-24 - Community list of transit APIs, apps, datasets, research, and software.
...
* [Awesome Hackathon](https://github.com/dribdat/awesome-hackathon) ⭐ 295 | 🐛 2 | 📅 2026-05-05 - Recommendations for crowdsourcing tools, primarily from the open data community.
